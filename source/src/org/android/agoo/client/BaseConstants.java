...
public interface BaseConstants
{
    ...
    public static final String ACTION_AGOO_SERIVE_ELECION_SOURCE = "election_source";
    public static final String ACTION_AGOO_SERIVE_METHOD = "method";
    public static final String ACTION_AGOO_SERIVE_TIMEOUT = "re_election";
    public static final String ACTION_AGOO_START = "start";
    public static final String ACTION_AGOO_STOP = "stop";
    public static final String AGOO_ACTION = "org.agoo.android.intent.action.";
    public static final String AGOO_BINDER_COMMAND = "binder_command";
    public static final String AGOO_BINDER_COMMAND_ELECTION = "binder_command_election";
    public static final String AGOO_BINDER_COMMAND_PING = "binder_command_ping";
    public static final String AGOO_COMMAND = "command";
    public static final String AGOO_COMMAND_ELECTION_RETRY = "election_retry";
    ...
    public static final String AGOO_COMMAND_SERVICE_DESTROY = "service_destroy";
    public static final String AGOO_COMMAND_UNREGISTRATION = "unregister";
    public static final String AGOO_ELECTION_CLIENT_PACK = "agoo_election_client_pack";
    public static final String AGOO_ELECTION_CLIENT_PRIORITY = "agoo_election_client_priority";
    public static final String AGOO_PACKAGE_NAME = "org.agoo.android";
    ...
    public static final String ELECTION_TIMEOUT = "election_timeout";
    ...
    public static final String ERROR_NEED_REGISTER = "ERROR_NEED_REGISTER";
    ...
    public static final String OLD_DEIVCETOKEN = "old_device_token";
