...
_L4:
    ...
    //                   2 246;
           goto _L1 _L2 _L3
_L1:
        return new String(abyte1, 0, i, "US_ASCII");
_L2:
        int k = i + 1;
        abyte1[i] = a[(abyte0[i1] & 0xff) >> 2];
        i = k + 1;
        abyte1[k] = a[(abyte0[i1] & 3) << 4];
        k = i + 1;
        abyte1[i] = 61;
        i = k + 1;
        abyte1[k] = 61;
...
_L3:
        ...
        abyte1[i] = a[(abyte0[i1] & 0xff) >> 2];
        i = l + 1;
        abyte1[l] = a[(abyte0[i1] & 3) << 4 | (abyte0[i1 + 1] & 0xff) >> 4];
        l = i + 1;
        abyte1[i] = a[(abyte0[i1 + 1] & 0xf) << 2];
        i = l + 1;
        abyte1[l] = 61;
