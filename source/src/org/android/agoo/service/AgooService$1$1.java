    ...
    implements Runnable
{
    ...
    // Unreferenced inner class org/android/agoo/service/AgooService$1

/* anonymous class */
    class AgooService._cls1 extends IMessageService.Stub
    {
        ...
        public void probe()
            throws RemoteException
        {
            bz.a(new AgooService._cls1._cls1(this));
        }
