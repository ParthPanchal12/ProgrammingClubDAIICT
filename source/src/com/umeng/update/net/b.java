...
public class com.umeng.update.net.b
{
    class a extends SQLiteOpenHelper
    {
        ...
        final com.umeng.update.net.b a;

        public void onCreate(SQLiteDatabase sqlitedatabase)
        {
            u.upd.b.c(com.umeng.update.net.b.a(), "CREATE TABLE umeng_download_task_list (cp TEXT, url TEXT, progress INTEGER, extra TEXT, last_modified TEXT, UNIQUE (cp,url) ON CONFLICT ABORT);");
    ...
    private static class b
    {
        ...
        public static final com.umeng.update.net.b a = new com.umeng.update.net.b(null);
    ...
    private static final String a = com/umeng/update/net/b.getName();
    ...
    private com.umeng.update.net.b()
    {
        k = new a(i);
    }

    com.umeng.update.net.b(com.umeng.update.net.b b1)
    {
        this();
    }

    public static com.umeng.update.net.b a(Context context)
    {
    ...
    public void a(int l)
    {
        try
        {
            ...
            u.upd.b.c(a, (new StringBuilder("clearOverdueTasks(")).append(l).append(")").append(" remove all tasks before ").append((new SimpleDateFormat("yyyy-MM-dd HH:mm:ss")).format(date)).toString());
            return;
        }
        catch (Exception exception)
        {
            u.upd.b.b(a, exception.getMessage());
        }
    }
    ...
    public void a(String s, String s1, int l)
    {
        ...
        contentvalues.put("last_modified", n.a());
        k.getWritableDatabase().update("umeng_download_task_list", contentvalues, "cp=? and url=?", new String[] {
            s, s1
        });
        u.upd.b.c(a, (new StringBuilder("updateProgress(")).append(s).append(", ").append(s1).append(", ").append(l).append(")").toString());
    }
    ...
    public void a(String s, String s1, String s2)
    {
        ...
        u.upd.b.c(a, (new StringBuilder("updateExtra(")).append(s).append(", ").append(s1).append(", ").append(s2).append(")").toString());
    }
...
_L1:
        u.upd.b.c(a, (new StringBuilder("insert(")).append(s).append(", ").append(s1).append("): ").append(" already exists in the db. Insert is cancelled.").toString());
        boolean flag = false;
_L4:
        cursor.close();
        return flag;
_L2:
        ...
        try
        {
            u.upd.b.c(a, (new StringBuilder("insert(")).append(s).append(", ").append(s1).append("): ").append("rowid=").append(l).toString());
        }
...
_L3:
        ...
        flag = false;
_L6:
        u.upd.b.c(a, (new StringBuilder("insert(")).append(s).append(", ").append(s1).append("): ").append(exception.getMessage()).toString(), exception);
        return flag;
        exception;
...
_L5:
    ...
    public Date d(String s, String s1)
    {
        ...
        if (cursor.getCount() > 0)
        {
            ...
            u.upd.b.c(a, (new StringBuilder("getLastModified(")).append(s).append(", ").append(s1).append("): ").append(((String) (obj))).toString());
            try
            {
    ...
    public void e(String s, String s1)
    {
        ...
        u.upd.b.c(a, (new StringBuilder("delete(")).append(s).append(", ").append(s1).append(")").toString());
    }
