...
_L1:
    ...
    public static B a = new c() {
        ...
        public j.y c(h h1, n n1)
            throws s
        {
            return new j.y(h1, n1, null);
        }
    ...
    protected c l()
    {
        return j.G().a(com/umeng/message/proguard/j$y, com/umeng/message/proguard/j$y$a);
    }
