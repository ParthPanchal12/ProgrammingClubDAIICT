...
_L4:
        ...
        a.post(new Runnable(arraylist1, arraylist) {
    ...
    _cls4.b(Conversation conversation, Handler handler, SyncListener synclistener)
    {
        c = conversation;
        a = handler;
        b = synclistener;
