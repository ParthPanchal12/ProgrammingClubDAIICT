    ...
    implements Runnable
{
    ...
    public void run()
    {
        ...
        if (c.c != null)
        {
            c.c.onReceiveDevReply(a);
            c.c.onSendUserReply(b);
        }
    }

    a(a a1, List list, List list1)
    {
        c = a1;
        a = list;
        b = list1;
...
label0:
            {
                ...
                {
                    a.post(new Conversation._cls1._cls3(reply));
                    l1 = l;
                }
            }
_L3:
...
_L4:
            ...
            a.post(new Conversation._cls1._cls4(this, arraylist1, arraylist));
            return;
        }
...
/* anonymous class */
        ...
        // Unreferenced inner class com/umeng/fb/model/Conversation$1$3

/* anonymous class */
        class Conversation._cls1._cls3
            implements Runnable
        {
