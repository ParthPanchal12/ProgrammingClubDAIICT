    ...
    implements Runnable
{
    ...
    public void run()
    {
        b.b.created_at = ((Long)a.get("created_at")).longValue();
        b.b.status = "sent";
        Collections.sort(Conversation.d(b.b));
...
/* anonymous class */
        ...
        implements Runnable
    {
        ...
        public void run()
        {
            ...
            {
                b.post(new Conversation._cls2._cls2(this, map));
                return;
            } else
            {
                b.post(new Conversation._cls2._cls3());
                return;
            }
        }
...
/* anonymous class */
        ...
        // Unreferenced inner class com/umeng/fb/model/Conversation$2$3

/* anonymous class */
        class Conversation._cls2._cls3
            implements Runnable
        {
