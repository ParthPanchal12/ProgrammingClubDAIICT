...
public class d
{
    ...
    public d(Context context, String s, AdSize adsize, e e1, c c1, int i1, boolean flag)
    {
        a = s;
        m = adsize;
        i = e1;
        ...
        l = i1;
        j = flag;
        s = AdInternalSettings.getCustomInitParams();
        if (s != null)
        {
            h = s;
        }
    ...
    private void h()
    {
        ...
        switch (com.facebook.ads.internal.dto._cls1.a[e.ordinal()])
        {
        default:
    ...
    public boolean f()
    {
        ...
        if (b != null && b.length() >= 0)
        {
            ...
            {
                Debug.e((new StringBuilder()).append("Invalid PUBLISHER_ID passed ").append(b).toString());
                return false;
            }
            if (i1 > 0)
            {
        ...
        {
            Debug.e("No PUBLISHER_ID passed");
            return false;
        }
    }
...
_L4:
        hashmap.put("ADAPTERS", com.facebook.ads.internal.adapters.f.a(d));
        if (i != null)
        {
        ...
        hashmap.put("CLIENT_EVENTS", com.facebook.ads.internal.util.c.a());
        return hashmap;
_L2:
        if (m != null)
        {
