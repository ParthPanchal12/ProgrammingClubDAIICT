    ...
    implements com.facebook.ads.internal.server.a.a
{
    ...
    private void m()
    {
        ...
        if (k() != ((AdAdapter) (obj2)).getPlacementType())
        {
            ...
            ((InterstitialAdapter) (obj1)).loadInterstitialAd(c, new InterstitialAdapterListener(((Runnable) (obj2))) {
                ...
                public void onInterstitialAdClicked(InterstitialAdapter interstitialadapter, String s1, boolean flag)
                {
                    ...
                    if (flag1)
                    {
                        ...
                        if (!(com.facebook.ads.internal.h.p(b).f instanceof Activity))
                        {
                        ...
                        com.facebook.ads.internal.h.p(b).f.startActivity(interstitialadapter);
                        return;
                    }
                }
...
_L2:
        ...
        obj = ((b) (obj)).a();
        l1 = ((c) (obj)).b();
        com.facebook.ads.internal._cls9.a[k().ordinal()];
