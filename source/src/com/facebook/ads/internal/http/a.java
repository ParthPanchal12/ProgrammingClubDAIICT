...
public class com.facebook.ads.internal.http.a
{
    ...
    public com.facebook.ads.internal.http.a(Context context, com.facebook.ads.internal.e e1)
    {
        f = context;
        ...
        HttpProtocolParams.setUserAgent(basichttpparams, (new StringBuilder()).append(h.a(context, e1)).append(" FacebookADsSDK/").append("4.1.2").append(" (").append("AB/").append(e.d).append(";").append("AV/").append(e.f).append(";").append("BV/").append(e.g).append(";").append("LC/").append(Locale.getDefault().toString()).append(")").toString());
