...
public class Mp3DownloadedAdapter extends BaseAdapter
{
    ...
    public View getView(final int position, View view, ViewGroup viewgroup)
    {
        ...
        if (view == null)
        {
            ...
            view = View.inflate(ctx, 0x7f03006e, null);
            viewgroup.my_delete_movie = (ImageView)view.findViewById(0x7f0601da);
            viewgroup.my_test_head_image = (ImageView)view.findViewById(0x7f0601db);
            viewgroup.my_movie_name_item = (TextView)view.findViewById(0x7f0601dc);
            viewgroup.my_totalsize = (TextView)view.findViewById(0x7f0601dd);
            viewgroup.my_stop_download_bt = (Button)view.findViewById(0x7f0601de);
