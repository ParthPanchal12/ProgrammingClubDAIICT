    ...
    implements ContentValue
{
    ...
    public View getView(int i, View view, ViewGroup viewgroup)
    {
        ...
        if (view == null)
        {
            ...
            view = View.inflate(ctx, 0x7f03006f, null);
            viewgroup.mp3title = (TextView)view.findViewById(0x7f0601e0);
            viewgroup.mp3album_title = (TextView)view.findViewById(0x7f0601e1);
            viewgroup.mp3artist_title = (TextView)view.findViewById(0x7f0601e2);
            viewgroup.mp3size = (TextView)view.findViewById(0x7f0601e3);
            viewgroup.mp3_download_bt = (Button)view.findViewById(0x7f0601e4);
            viewgroup.list_bg = (RelativeLayout)view.findViewById(0x7f0601df);
...
_L2:
        if (j == i)
        {
            ((ViewHolder) (viewgroup)).list_bg.setBackgroundResource(0x7f020139);
        } else
        {
            ((ViewHolder) (viewgroup)).list_bg.setBackgroundResource(0x7f020104);
        }
                ...
                if (dbUtils.queryfile(in_fo.getId()) == null)
                {
                    (in_fo. new AsyncTask() {
                        ...
                        protected void onPostExecute(Void void1)
                        {
                            ...
                            {
                                Toast.makeText(ctx, ctx.getString(0x7f0b006e), 1).show();
                            }
                            void1 = new Intent();
