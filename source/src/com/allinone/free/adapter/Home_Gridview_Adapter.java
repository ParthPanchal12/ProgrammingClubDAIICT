...
_L3:
    ...
    public View getView(int i, View view, ViewGroup viewgroup)
    {
        ...
        if (view == null)
        {
            ...
            view = View.inflate(ctx, 0x7f030052, null);
            viewgroup.gvimg = (ImageView)view.findViewById(0x7f060133);
            viewgroup.gvtitle = (TextView)view.findViewById(0x7f060134);
            viewgroup.gvdown = (Button)view.findViewById(0x7f060136);
            viewgroup.gvratingbar = (RatingBar)view.findViewById(0x7f060135);
            view.setTag(viewgroup);
        } else
        {
            viewgroup = (ViewHolder)view.getTag();
        }
        ((ViewHolder) (viewgroup)).gvtitle.setText(((DownloadMovieItem)list.get(i)).getTitle());
        ((ViewHolder) (viewgroup)).gvratingbar.setRating(((DownloadMovieItem)list.get(i)).getRating().floatValue());
        app.asyncLoadImage(((DownloadMovieItem)list.get(i)).getIcon(), ((ViewHolder) (viewgroup)).gvimg);
        has_apk = in_fo.getHas_apk();
        if (!has_apk.equals("1")) goto _L2; else goto _L1
_L1:
        ((ViewHolder) (viewgroup)).gvdown.setBackgroundResource(0x7f020075);
_L4:
        ((ViewHolder) (viewgroup)).gvdown.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            {
                ((Button)view1).setBackgroundResource(0x7f0200f8);
...
_L2:
        if (has_apk.equals("0"))
        {
            ((ViewHolder) (viewgroup)).gvdown.setBackgroundResource(0x7f0200e1);
        }
        if (true) goto _L4; else goto _L3
_L3:
    }
