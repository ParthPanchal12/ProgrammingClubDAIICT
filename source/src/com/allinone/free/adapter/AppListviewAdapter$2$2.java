...
_L1:
            (new Thread(new AppListviewAdapter._cls2._cls1())).start();
...
_L2:
            if (has_apk.equals("0"))
            {
                (new Thread(in_fo. new AppListviewAdapter._cls2._cls2())).start();
...
_L5:
        ...
        // Unreferenced inner class com/allinone/free/adapter/AppListviewAdapter$2$1

/* anonymous class */
        class AppListviewAdapter._cls2._cls1
            implements Runnable
        {
