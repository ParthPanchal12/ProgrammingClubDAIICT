...
class val.in_fo extends AsyncTask
{
    ...
    protected void onPostExecute(Void void1)
    {
        ...
        {
            Toast.makeText(Mp3ListviewAdapter.access$2(_fld0), Mp3ListviewAdapter.access$2(_fld0).getString(0x7f0b006e), 1).show();
        }
        void1 = new Intent();
...
_L3:
    ...
    // Unreferenced inner class com/allinone/free/adapter/Mp3ListviewAdapter$1
...
/* anonymous class */
        ...
        implements android.view.View.OnClickListener
    {
        ...
        // Unreferenced inner class com/allinone/free/adapter/Mp3ListviewAdapter$1$1
