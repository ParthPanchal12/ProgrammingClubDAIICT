    ...
    implements android.view.View.OnClickListener
{
    ...
    private void initPopuWindow1(View view1)
    {
        if (mWindow == null)
        {
            view = LayoutInflater.from(ctx).inflate(0x7f03008a, null);
            mWindow = new PopupWindow(view, -1, -1);
            l1 = (LinearLayout)view.findViewById(0x7f060010);
            l2 = (LinearLayout)view.findViewById(0x7f060243);
            l3 = (LinearLayout)view.findViewById(0x7f060244);
            l4 = (LinearLayout)view.findViewById(0x7f060245);
            popodismiss = (RelativeLayout)view.findViewById(0x7f060242);
        }
    ...
    public View getView(final int position, View view1, final ViewGroup in_fo)
    {
        ...
        if (view1 == null)
        {
            ...
            view1 = View.inflate(ctx, 0x7f030087, null);
            holder.my_delete_movie = (ImageView)view1.findViewById(0x7f060232);
            holder.my_test_head_image3 = (ImageView)view1.findViewById(0x7f060233);
            holder.my_movie_name_item = (TextView)view1.findViewById(0x7f060234);
            holder.my_totalsize = (TextView)view1.findViewById(0x7f060235);
            holder.my_stop_download_bt = (Button)view1.findViewById(0x7f060236);
            view1.setTag(holder);
        } else
        {
