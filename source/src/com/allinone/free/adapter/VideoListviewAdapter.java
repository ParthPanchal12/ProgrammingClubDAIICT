...
public class VideoListviewAdapter extends BaseAdapter
{
    ...
    public View getView(int i, View view, ViewGroup viewgroup)
    {
        ...
        if (view == null)
        {
            ...
            view = View.inflate(ctx, 0x7f0300a1, null);
            viewgroup.tv_format = (TextView)view.findViewById(0x7f060289);
            viewgroup.tv_type = (TextView)view.findViewById(0x7f06028a);
            viewgroup.tv_size = (TextView)view.findViewById(0x7f06028b);
