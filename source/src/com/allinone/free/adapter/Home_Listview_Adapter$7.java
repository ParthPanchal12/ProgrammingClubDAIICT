...
class val.ppp
    implements android.view.ew_Adapter._cls7
{
    ...
    public void onClick(View view)
    {
        ...
        view = new Intent(Home_Listview_Adapter.access$0(Home_Listview_Adapter.this), com/allinone/free/activity/FunGifActivity);
