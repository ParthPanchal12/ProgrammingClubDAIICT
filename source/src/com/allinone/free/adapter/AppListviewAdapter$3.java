...
class content extends AsyncTask
{
    ...
    {
        options = AppListviewAdapter.access$9(AppListviewAdapter.this);
        ...
        if (AppListviewAdapter.access$11(AppListviewAdapter.this).findItemsByWhereAndWhereValue("downloadUrl", avoid, com/allinone/free/mydownload/DownloadMovieItem, "downloadtask2", null).size() > 0)
        {
            avoid = new Message();
            avoid.what = 2;
            handler.sendMessage(avoid);
