    ...
    implements android.view.iewAdapter._cls2
{
    ...
    {
        AppListviewAdapter.access$3(AppListviewAdapter.this).edit().putString("appname", val$in_fo.getTitle()).commit();
        AppListviewAdapter.access$4(AppListviewAdapter.this).edit().putString("appid", val$in_fo.getId()).commit();
...
_L6:
        return;
_L4:
        if (AppListviewAdapter.access$8(AppListviewAdapter.this).queryfile(val$in_fo.getId()) == null)
        {
