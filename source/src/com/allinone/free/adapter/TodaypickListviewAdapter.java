    ...
    implements ContentValue
{
    ...
    public View getView(int i, final View has_apk, ViewGroup viewgroup)
    {
        ...
        if (has_apk == null)
        {
            ...
            view = View.inflate(ctx, 0x7f030094, null);
            viewgroup.todaytime = (TextView)view.findViewById(0x7f060266);
            viewgroup.todaytitletv = (TextView)view.findViewById(0x7f060268);
            viewgroup.todayhits = (TextView)view.findViewById(0x7f06026a);
            viewgroup.todayimg = (ImageView)view.findViewById(0x7f060267);
            viewgroup.todayratingbar = (RatingBar)view.findViewById(0x7f060269);
            viewgroup.todaydownload_bt = (Button)view.findViewById(0x7f06026b);
        ...
        app.asyncLoadImage(in_fo.getMovieHeadImagePath(), ((ViewHolder) (viewgroup)).todayimg);
        has_apk = in_fo.getHas_apk();
        if (has_apk.equals("1"))
        {
            ((ViewHolder) (viewgroup)).todaydownload_bt.setBackgroundResource(0x7f020075);
        } else
        if (has_apk.equals("0"))
        {
            ((ViewHolder) (viewgroup)).todaydownload_bt.setBackgroundResource(0x7f0200e1);
        }
