    ...
    implements ContentValue
{
    ...
    public View getView(int i, View view, ViewGroup viewgroup)
    {
        ...
        if (view == null)
        {
            ...
            view = View.inflate(ctx, 0x7f030088, null);
            viewgroup.ringtonetitle = (TextView)view.findViewById(0x7f060237);
            viewgroup.ringtonecat = (TextView)view.findViewById(0x7f060238);
            viewgroup.ringtone_ratingbar = (RatingBar)view.findViewById(0x7f060239);
            viewgroup.ringtone_download_bt = (Button)view.findViewById(0x7f06023a);
