...
public class JazzyViewPager extends ViewPager
{
    private static final class State extends Enum
    {
        ...
        {
            return (State)Enum.valueOf(com/allinone/free/pager/JazzyViewPager$State, s);
        }
    ...
    public static final class TransitionEffect extends Enum
    {
        ...
        {
            return (TransitionEffect)Enum.valueOf(com/allinone/free/pager/JazzyViewPager$TransitionEffect, s);
        }
    ...
    private static int $SWITCH_TABLE$com$allinone$free$pager$JazzyViewPager$TransitionEffect[];
    ...
    static int[] $SWITCH_TABLE$com$allinone$free$pager$JazzyViewPager$TransitionEffect()
    {
        int ai[] = $SWITCH_TABLE$com$allinone$free$pager$JazzyViewPager$TransitionEffect;
        if (ai != null)
        {
            return ai;
        }
        ...
        $SWITCH_TABLE$com$allinone$free$pager$JazzyViewPager$TransitionEffect = ai;
        return ai;
    }
    ...
    public JazzyViewPager(Context context, AttributeSet attributeset)
    {
        ...
        context = context.obtainStyledAttributes(attributeset, com.allinone.free.R.styleable.JazzyViewPager);
        int i = context.getInt(0, 0);
        setTransitionEffect(TransitionEffect.valueOf(getResources().getStringArray(0x7f0d0000)[i]));
        ...
        $SWITCH_TABLE$com$allinone$free$pager$JazzyViewPager$TransitionEffect()[mEffect.ordinal()];
