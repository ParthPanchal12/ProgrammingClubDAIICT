...
/* anonymous class */
    class RubActivity._cls1._cls1 extends AsyncTask
    {
        ...
        protected void onPostExecute(final Void dialog1)
        {
            ...
            button.setOnClickListener(new RubActivity._cls1._cls1._cls1());
            button1.setOnClickListener(dialog1. new RubActivity._cls1._cls1._cls2());
        }
        ...
        // Unreferenced inner class com/allinone/free/cleaner/RubActivity$1$1$1

/* anonymous class */
        class RubActivity._cls1._cls1._cls1
