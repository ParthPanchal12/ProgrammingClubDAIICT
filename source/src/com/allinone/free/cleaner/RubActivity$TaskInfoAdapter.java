...
private class this._cls0 extends BaseAdapter
{
    ...
    public View getView(int i, View view, ViewGroup viewgroup)
    {
        ...
        _lcls0._process_icon = (ImageView)view.findViewById(0x7f06021f);
        _lcls0._process_name = (TextView)view.findViewById(0x7f060220);
        _lcls0._process_memory = (TextView)view.findViewById(0x7f060221);
        _lcls0._process_state = (CheckBox)view.findViewById(0x7f060222);
        view.setTag(_lcls0);
