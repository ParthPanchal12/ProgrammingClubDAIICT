...
class content extends AsyncTask
{
    ...
    protected transient Void doInBackground(Void avoid[])
    {
        ...
        if (RubActivity.access$57(RubActivity.this).findItemsByWhereAndWhereValue("downloadUrl", avoid, com/allinone/free/mydownload/DownloadMovieItem, "downloadtask2", null).size() > 0)
        {
            avoid = new Message();
            avoid.what = 2;
            handler.sendMessage(avoid);
