...
public class ShowCleanActivity_Rub extends BaseActivity
{
    ...
    protected void onCreate(Bundle bundle)
    {
        ...
        init();
        initView();
        relaquan = (RelativeLayout)findViewById(0x7f060261);
        ...
        header_left_showclean = (ImageView)findViewById(0x7f060255);
        ...
        tv_jieguo = (TextView)findViewById(0x7f060259);
        ...
        bundle = AnimationUtils.loadAnimation(this, 0x7f04001c);
    ...
    {
        startActivity(new Intent(getApplicationContext(), com/allinone/free/activity/DownloadsActivity));
        publicTools.cleanertag = false;
        finish();
