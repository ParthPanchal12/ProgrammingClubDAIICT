...
public class PullToRefreshLayout extends RelativeLayout
{
    ...
    private void changeState(int i)
    {
        ...
        case 0: // '\0'
            ...
            refreshStateTextView.setText(0x7f0b0065);
            pullView.startAnimation((RotateAnimation)AnimationUtils.loadAnimation(getContext(), 0x7f040018));
            pullView.setVisibility(0);
            return;

        case 1: // '\001'
            refreshStateTextView.setText(0x7f0b0066);
        ...
        refreshStateTextView.setText(0x7f0b0067);
    }
    ...
    {
        pullView = refreshView.findViewById(0x7f06022d);
        refreshStateTextView = (TextView)refreshView.findViewById(0x7f06022b);
        refreshingView = refreshView.findViewById(0x7f060229);
        refreshStateImageView = refreshView.findViewById(0x7f06022c);
    }

    private void initView(Context context)
    {
        timer = new MyTimer(updateHandler);
        rotateAnimation = (RotateAnimation)AnimationUtils.loadAnimation(context, 0x7f040017);
        refreshingAnimation = (RotateAnimation)AnimationUtils.loadAnimation(context, 0x7f040019);
...
_L1:
        ...
        refreshStateTextView.setText(0x7f0b0069);
        refreshStateImageView.setBackgroundResource(0x7f020185);
_L4:
        (new Handler() {
...
_L2:
        refreshStateImageView.setVisibility(0);
        refreshStateTextView.setText(0x7f0b0068);
        refreshStateImageView.setBackgroundResource(0x7f020186);
