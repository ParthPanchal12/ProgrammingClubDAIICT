...
public class UpdateDialogVerison2 extends Dialog
{
    ...
    public UpdateDialogVerison2(Context context, int i, android.view.View.OnClickListener onclicklistener)
    {
        ...
        options = (new com.nostra13.universalimageloader.core.DisplayImageOptions.Builder()).cacheOnDisc().showImageForEmptyUri(0x7f020112).displayer(new RoundedBitmapDisplayer(8)).build();
    }
    ...
    protected void onCreate(Bundle bundle)
    {
        ...
        btnCancel = (Button)findViewById(0x7f0600ec);
        btnEnter = (Button)findViewById(0x7f0600ed);
        tvTitle = (TextView)findViewById(0x7f060029);
        tvContent = (TextView)findViewById(0x7f06002a);
        imgIcon = (ImageView)findViewById(0x7f0600eb);
