...
public class ProgressWheel extends View
{
    ...
    private static final String TAG = com/allinone/free/utils/ProgressWheel.getSimpleName();
    ...
    public ProgressWheel(Context context, AttributeSet attributeset)
    {
        ...
        mTargetProgress = 0.0F;
        isSpinning = false;
        parseAttributes(context.obtainStyledAttributes(attributeset, com.allinone.free.R.styleable.ProgressWheel));
    }
