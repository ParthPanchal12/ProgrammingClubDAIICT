    ...
    implements Runnable
{
    ...
    public void run()
    {
        Object obj = URLEncoder.encode(Mp3Activity.access$9(_fld0).getText().toString());
        Myutils.getInstance();
...
/* anonymous class */
        ...
        implements android.view.View.OnKeyListener
    {
        ...
        // Unreferenced inner class com/allinone/free/activity/Mp3Activity$5$2

/* anonymous class */
        class Mp3Activity._cls5._cls2
            implements Runnable
        {
            ...
            public void run()
            {
                String s = URLEncoder.encode(Mp3Activity.access$9(this$0).getText().toString());
