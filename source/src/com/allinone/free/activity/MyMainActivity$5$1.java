...
/* anonymous class */
    class MyMainActivity._cls5 extends Handler
    {
        ...
        public void handleMessage(final Message ntPath)
        {
            if (ntPath.what == 564 && MyMainActivity.access$11(MyMainActivity.this))
            {
                ...
                if (!MyMainActivity.access$1(MyMainActivity.this).equals(""))
                {
                    ...
                    MyMainActivity._cls5._cls1 _lcls1 = new MyMainActivity._cls5._cls1();
                    updateDialogVersion = new UpdateDialogVerison(MyMainActivity.this, 0x7f0c0066, _lcls1);
                ...
                if (ntPath != null && !"".equals(ntPath))
                {
                    ...
                    {
                        itemsOnClick2 = new MyMainActivity._cls5._cls2();
                        ntPath = new Message();
                        ntPath.what = 10000;
        ...
        // Unreferenced inner class com/allinone/free/activity/MyMainActivity$5$2

/* anonymous class */
        class MyMainActivity._cls5._cls2
