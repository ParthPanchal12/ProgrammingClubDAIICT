    ...
    implements android.view.r
{
    ...
    {
        MyMainActivity.access$2(_fld0).dismiss();
        switch (view.getId())
        {
        case 2131099881: 
        default:
...
/* anonymous class */
    class MyMainActivity._cls1 extends Handler
    {
        ...
        public void handleMessage(final Message dialog)
        {
            ...
            dialog = new MyMainActivity._cls1._cls1();
            ...
            ((Button)dialog.findViewById(0x7f06020e)).setOnClickListener(new MyMainActivity._cls1._cls2());
            return;
            dialog;
        }
        ...
        // Unreferenced inner class com/allinone/free/activity/MyMainActivity$1$2

/* anonymous class */
        class MyMainActivity._cls1._cls2
