...
_L7:
    ...
    public GameActivity()
    {
        game = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent)
            {
                try
                {
                    db = new FinalDBChen(GameActivity.this, getDatabasePath("download2.db").getAbsolutePath());
    ...
    private void bindListeners()
    {
        ...
        gametopsearch.setOnClickListener(new android.view.View.OnClickListener() {
        ...
        gametopgift.setOnClickListener(new android.view.View.OnClickListener() {
        ...
        apptodown.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            public void onClick(View view1)
            {
                startActivity(new Intent(GameActivity.this, com/allinone/free/activity/DownloadsActivity));
            }
    ...
    {
        nativeAdfb.registerViewForInteraction(gametopgift);
    }

    private void init()
    {
        gamefan = getIntent().getBooleanExtra("gamefan", false);
        listtitle = (TextView)findViewById(0x7f0600c1);
        listtitle.setText("Game");
        gametopsearch = (ImageView)findViewById(0x7f0600c2);
        gametopgift = (ImageView)findViewById(0x7f0600c3);
