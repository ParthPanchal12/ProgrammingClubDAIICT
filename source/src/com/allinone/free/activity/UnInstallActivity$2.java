...
class content extends AsyncTask
{
    ...
    {
        options = UnInstallActivity.access$2(UnInstallActivity.this);
        ...
        if (UnInstallActivity.access$4(UnInstallActivity.this).findItemsByWhereAndWhereValue("downloadUrl", avoid, com/allinone/free/mydownload/DownloadMovieItem, "downloadtask2", null).size() > 0)
        {
            avoid = new Message();
            avoid.what = 2;
            handler.sendMessage(avoid);
    ...
    protected void onPostExecute(Void void1)
    {
        ...
        UnInstallActivity.access$1(UnInstallActivity.this).setVisibility(8);
    }

    protected void onPreExecute()
    {
        super.onPreExecute();
        UnInstallActivity.access$1(UnInstallActivity.this).setVisibility(0);
    }
