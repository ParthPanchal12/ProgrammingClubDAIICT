    ...
    implements Runnable
{
    ...
    public void run()
    {
        String s = URLEncoder.encode(RingtoneActivity.access$9(_fld0).getText().toString());
...
/* anonymous class */
        ...
        implements android.view.View.OnKeyListener
    {
        ...
        // Unreferenced inner class com/allinone/free/activity/RingtoneActivity$5$1

/* anonymous class */
        class RingtoneActivity._cls5._cls1
            implements Runnable
        {
            ...
            public void run()
            {
                Object obj = URLEncoder.encode(RingtoneActivity.access$9(this$0).getText().toString());
                Myutils.getInstance();
