    ...
    implements Runnable
{
    ...
    public void run()
    {
        String s = URLEncoder.encode(AppRecommendKeywordsActivity.access$2(_fld0).getText().toString());
    ...
    // Unreferenced inner class com/allinone/free/activity/AppRecommendKeywordsActivity$6

/* anonymous class */
    class AppRecommendKeywordsActivity._cls6
...
_L3:
            try
            {
                (new Thread(new AppRecommendKeywordsActivity._cls6._cls1())).start();
            }
            // Misplaced declaration of an exception variable
            catch (View view)
            {
