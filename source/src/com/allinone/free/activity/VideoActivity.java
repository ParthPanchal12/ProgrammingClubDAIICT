...
_L5:
        ...
        protected void onPostExecute(ArrayList arraylist)
        {
            ...
            if (arraylist.size() == 0)
            {
                final RestaryDownloadDialog restarydialog = new RestaryDownloadDialog(VideoActivity.this, 0x7f0c0064);
                restarydialog.setCanceledOnTouchOutside(false);
                restarydialog.show();
                Button button = (Button)restarydialog.findViewById(0x7f06022f);
                Button button1 = (Button)restarydialog.findViewById(0x7f060230);
...
_L5:
    ...
    {
        final ErrorDialog dialog = new ErrorDialog(this, 0x7f0c0064);
...
label1:
    ...
    {
        final VideoDownloadDialog dialog = new VideoDownloadDialog(this, 0x7f0c0064);
        dialog.setCanceledOnTouchOutside(false);
        if (list.size() > 0)
        {
            dialog.show();
            video_download_img = (ImageView)dialog.findViewById(0x7f0602a1);
            videotitle = (TextView)dialog.findViewById(0x7f0602a2);
            video_download_item_listview = (ListView)dialog.findViewById(0x7f0602a3);
    ...
    private void init()
    {
        videojianpan = (RelativeLayout)findViewById(0x7f060295);
        sp_config = getSharedPreferences("banner_type", 0);
        fan = (ImageView)findViewById(0x7f060296);
        tvloading = (TextView)findViewById(0x7f06029b);
        video_title = (TextView)findViewById(0x7f060297);
        videowebview = (WebView)findViewById(0x7f06029a);
        mychafan = (ImageView)findViewById(0x7f060298);
        videobanner = (LinearLayout)findViewById(0x7f0602a0);
        progressWheel = (ProgressWheel)findViewById(0x7f060075);
        net_hint_img_list = (ImageView)findViewById(0x7f060190);
        net_hint_img_list.setVisibility(8);
        videodownloader = (Button)findViewById(0x7f06029d);
        videodownloader2 = (Button)findViewById(0x7f06029e);
        videoreload = (Button)findViewById(0x7f06029f);
        lieshow = (LinearLayout)findViewById(0x7f06029c);
    ...
    public void VideoDownload(String s, String s1, String s2, String s3)
    {
        ...
        if (db.findItemsByWhereAndWhereValue("file_id", s, com/allinone/free/mydownload/DownloadMovieItem, "downloadtask2", null).size() > 0)
        {
            Mydialog();
            return;
        } else
