...
class content extends AsyncTask
{
    ...
    {
        options = AnzhuangActivity.access$2(AnzhuangActivity.this);
        ...
        if (AnzhuangActivity.access$4(AnzhuangActivity.this).findItemsByWhereAndWhereValue("downloadUrl", avoid, com/allinone/free/mydownload/DownloadMovieItem, "downloadtask2", null).size() > 0)
        {
            avoid = new Message();
            avoid.what = 2;
            handler.sendMessage(avoid);
    ...
    protected void onPostExecute(Void void1)
    {
        ...
        AnzhuangActivity.access$1(AnzhuangActivity.this).setVisibility(8);
    }

    protected void onPreExecute()
    {
        super.onPreExecute();
        AnzhuangActivity.access$1(AnzhuangActivity.this).setVisibility(0);
    }
