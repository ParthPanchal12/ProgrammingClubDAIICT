    ...
    implements android.view.View.OnClickListener
{
    ...
    private void buildLister()
    {
        ...
        playpauseringtone.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                {
                    player.pause();
                    playpauseringtone.setBackgroundResource(0x7f020177);
                    istag = Boolean.valueOf(false);
                    return;
                } else
                {
                    player.play();
                    playpauseringtone.setBackgroundResource(0x7f020179);
                    istag = Boolean.valueOf(true);
                    return;
                }
            }
    ...
    private void init()
    {
        ...
        ringtonefan = (ImageView)findViewById(0x7f06023b);
        filemoreringtone = (ImageView)findViewById(0x7f06023c);
        ringtonenotice = (TextView)findViewById(0x7f06023e);
        ringtone_lv = (ListView)findViewById(0x7f06023d);
        adapter = new RingtoneDownloadedAdapter(this, listdd);
        ringtone_lv.setAdapter(adapter);
        playpauseringtone = (ImageView)findViewById(0x7f060240);
        charingtone = (ImageView)findViewById(0x7f060241);
        playbarringtone = (RelativeLayout)findViewById(0x7f06023f);
    ...
    public void onClick(final View downloadpathCustomDialog)
    {
        ...
        case 2131099915: 
            (new android.app.AlertDialog.Builder(this)).setTitle(getString(0x7f0b003e)).setMessage(getString(0x7f0b004d)).setPositiveButton(getString(0x7f0b0046), new android.content.DialogInterface.OnClickListener() {
