...
class this._cls1
    implements com.allinone.free.utils.ack
{
    ...
    {
        if (MyMainActivity.access$38(_fld0) != null)
        {
            MyMainActivity.access$39(_fld0, bitmap.getWidth());
            MyMainActivity.access$40(_fld0, bitmap.getHeight());
            s = new android.widget.arams(-1, getHeight(MyMainActivity.access$41(_fld0), MyMainActivity.access$42(_fld0)));
            MyMainActivity.access$38(_fld0).setLayoutParams(s);
            MyMainActivity.access$38(_fld0).setImageBitmap(bitmap);
        }
    }
...
/* anonymous class */
        ...
        implements IMNativeListener
    {
        ...
        // Unreferenced inner class com/allinone/free/activity/MyMainActivity$15$2

/* anonymous class */
        class MyMainActivity._cls15._cls2
