    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/allinone/free/activity/AppDetailsActivity$5

/* anonymous class */
    class AppDetailsActivity._cls5 extends Handler
    {
...
_L1:
            ...
            return;
_L2:
            (new Thread(new AppDetailsActivity._cls5._cls1())).start();
