...
class this._cls1 extends TimerTask
{
    ...
    // Unreferenced inner class com/allinone/free/activity/MyMainActivity$23

/* anonymous class */
    class MyMainActivity._cls23
        implements Runnable
    {
...
_L3:
            ...
            MyMainActivity.access$54(MyMainActivity.this, jsonobject.getString("ad_banner"));
            if (MyMainActivity.access$55(MyMainActivity.this).equals("admob"))
            {
                obj = new Message();
                obj.what = 10;
                handlertimer.sendMessage(((Message) (obj)));
            }
            MyMainActivity.access$56(MyMainActivity.this).edit().putString("banner_type", MyMainActivity.access$55(MyMainActivity.this)).commit();
...
_L6:
            if (!MyMainActivity.access$57(MyMainActivity.this).exists()) goto _L9; else goto _L8
_L8:
            Log.e("www", "eeeeee");
            (new File((new StringBuilder()).append(MyMainActivity.access$57(MyMainActivity.this)).append(File.separator).append("aioupdate.apk").toString())).delete();
_L10:
            if (MyMainActivity.access$58(MyMainActivity.this).query(MyMainActivity.access$33(MyMainActivity.this)) == 32)
            {
                MyMainActivity.access$60(MyMainActivity.this, MyMainActivity.access$58(MyMainActivity.this).add(MyMainActivity.access$59(MyMainActivity.this)));
            }
_L7:
            ...
            {
                (new Timer()).schedule(new MyMainActivity._cls23._cls1(), 0L, Myutils.big_ad_interval);
            }
