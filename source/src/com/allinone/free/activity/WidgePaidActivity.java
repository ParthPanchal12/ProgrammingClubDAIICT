    ...
    implements android.view.View.OnClickListener, AdListener
{
    ...
    private void ShowResult(String s)
    {
        ...
        adapter = new WidgetPaidGridviewAdapter(getApplicationContext(), gvlist, "widgetpaid");
    ...
    private void facebookad()
    {
        ...
        nativeAdfb.registerViewForInteraction(widgetgift);
    }
    ...
    private void init()
    {
        ...
        widgetgift = (ImageView)findViewById(0x7f0602b6);
        widgetgift.setOnClickListener(new android.view.View.OnClickListener() {
        ...
        widgetmoregame = (LinearLayout)findViewById(0x7f0602b8);
        ...
        textview = (TextView)findViewById(0x7f0602b5);
        textview1 = (TextView)findViewById(0x7f0602b7);
    ...
    public void onClick(View view)
    {
        ...
        case 2131100344: 
            view = new ComponentName("com.allinone.free", "com.allinone.free.activity.PaidforFreeActivity");
            break;
        }
        Intent intent1 = new Intent();
        intent1.putExtra("paidfan", true);
