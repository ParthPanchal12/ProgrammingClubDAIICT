...
class content extends AsyncTask
{
    ...
    {
        options = MyMainActivity.access$52(MyMainActivity.this);
        ...
        if (MyMainActivity.access$5(MyMainActivity.this).findItemsByWhereAndWhereValue("downloadUrl", avoid, com/allinone/free/mydownload/DownloadMovieItem, "downloadtask2", null).size() > 0)
        {
            avoid = new Message();
            avoid.what = 2;
            handler.sendMessage(avoid);
