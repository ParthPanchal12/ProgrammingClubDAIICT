...
class this._cls1 extends AsyncTask
{
    ...
    // Unreferenced inner class com/allinone/free/activity/MyMainActivity$6

/* anonymous class */
    class MyMainActivity._cls6 extends Handler
    {
...
_L3:
            ...
            catch (JSONException jsonexception)
            {
                ...
                (new MyMainActivity._cls6._cls1()).execute(new Void[0]);
            }
            continue; /* Loop/switch isn't completed */
_L2:
            if (MyMainActivity.access$11(MyMainActivity.this))
            {
                (new MyMainActivity._cls6._cls2()).execute(new Void[0]);
            }
...
_L4:
        ...
        // Unreferenced inner class com/allinone/free/activity/MyMainActivity$6$2

/* anonymous class */
        class MyMainActivity._cls6._cls2 extends AsyncTask
        {
