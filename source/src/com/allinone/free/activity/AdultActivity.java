...
public class AdultActivity extends SherlockFragmentActivity
...
_L6:
    ...
    public AdultActivity()
    {
        adult = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent)
            {
                try
                {
                    db = new FinalDBChen(AdultActivity.this, getDatabasePath("download2.db").getAbsolutePath());
    ...
    private void bindListeners()
    {
        ...
        adulttopsearch.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            public void onClick(View view1)
            {
                startActivity(new Intent(AdultActivity.this, com/allinone/free/activity/AppRecommendKeywordsActivity));
            }
    ...
    private void init()
    {
        ...
        indicatorWidth = ((DisplayMetrics) (obj)).widthPixels / 4 + DisplayUtil.dip2px(getApplicationContext(), 46F);
