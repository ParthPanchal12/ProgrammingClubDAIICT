...
public class TipsToast extends Toast
{
    ...
    public static TipsToast makeText(Context context, CharSequence charsequence, int i)
    {
        ...
        context = ((LayoutInflater)context.getSystemService("layout_inflater")).inflate(0x7f0300a7, null);
        ((TextView)context.findViewById(0x7f0602a6)).setText(charsequence);
    ...
    public void setIcon(int i)
    {
        ...
        ImageView imageview = (ImageView)getView().findViewById(0x7f0602a5);
        if (imageview == null)
        {
            throw new RuntimeException("This Toast was not created with Toast.makeText()");
        } else
    ...
    public void setText(CharSequence charsequence)
    {
        ...
        TextView textview = (TextView)getView().findViewById(0x7f0602a6);
        if (textview == null)
        {
            throw new RuntimeException("This Toast was not created with Toast.makeText()");
        } else
