...
class this._cls1
    implements com.allinone.free.utils.llback
{
    ...
    {
        if (MainActivity.access$3(_fld0) != null)
        {
            MainActivity.access$4(_fld0, bitmap.getWidth());
            MainActivity.access$5(_fld0, bitmap.getHeight());
            s = new android.widget.utParams(-1, tHeight(MainActivity.access$6(_fld0), MainActivity.access$7(_fld0)));
            MainActivity.access$3(_fld0).setLayoutParams(s);
            MainActivity.access$3(_fld0).setImageBitmap(bitmap);
        }
    }
...
/* anonymous class */
        ...
        implements IMNativeListener
    {
        ...
        // Unreferenced inner class com/allinone/free/start_welcome/MainActivity$2$2
