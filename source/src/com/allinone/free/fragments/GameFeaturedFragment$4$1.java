...
class this._cls1
    implements com.allinone.free.utils._cls4._cls1
{
    ...
    {
        if (GameFeaturedFragment.access$6(_fld0) != null)
        {
            GameFeaturedFragment.access$7(_fld0, bitmap.getWidth());
            GameFeaturedFragment.access$8(_fld0, bitmap.getHeight());
            s = new android.widget.(-1, getHeight(GameFeaturedFragment.access$9(_fld0), GameFeaturedFragment.access$10(_fld0)));
            GameFeaturedFragment.access$6(_fld0).setLayoutParams(s);
            GameFeaturedFragment.access$6(_fld0).setImageBitmap(bitmap);
        }
    }
...
/* anonymous class */
        ...
        implements IMNativeListener
    {
        ...
        // Unreferenced inner class com/allinone/free/fragments/GameFeaturedFragment$4$2

/* anonymous class */
        class GameFeaturedFragment._cls4._cls2
