    ...
    implements android.view.ner
{
    ...
    public void onClick(View view)
    {
        ...
        case 2131099882: 
            view = new Intent("android.intent.action.VIEW", Uri.parse(HomeFragment.access$3(_fld0)));
            break;
        }
        updateDialogVersion.dismiss();
        startActivity(view);
...
/* anonymous class */
    class HomeFragment._cls3 extends Handler
    {
        ...
        public void handleMessage(final Message ntPath)
        {
            if (ntPath.what == 564 && HomeFragment.access$1(HomeFragment.this))
            {
                ...
                if (!HomeFragment.access$3(HomeFragment.this).equals(""))
                {
                    ...
                    HomeFragment._cls3._cls1 _lcls1 = new HomeFragment._cls3._cls1();
                    updateDialogVersion = new UpdateDialogVerison(getActivity(), 0x7f0c0066, _lcls1);
                ...
                if (ntPath != null && !"".equals(ntPath))
                {
                    ...
                    {
                        itemsOnClick2 = new HomeFragment._cls3._cls2();
                        ntPath = new Message();
                        ntPath.what = 10000;
        ...
        // Unreferenced inner class com/allinone/free/fragments/HomeFragment$3$2

/* anonymous class */
        class HomeFragment._cls3._cls2
