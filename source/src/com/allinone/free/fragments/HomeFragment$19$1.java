...
class this._cls1 extends TimerTask
{
    ...
    // Unreferenced inner class com/allinone/free/fragments/HomeFragment$19

/* anonymous class */
    class HomeFragment._cls19
        implements Runnable
    {
...
_L1:
            ...
            {
                (new Timer()).schedule(new HomeFragment._cls19._cls1(), 0L, Myutils.big_ad_interval);
            }
