...
public class VideoFragment extends Fragment
{
    ...
    private void init(View view1)
    {
        ...
        appnotice = (TextView)view1.findViewById(0x7f060294);
        video_lv = (ListView)view1.findViewById(0x7f060293);
    ...
    public void VideoSort(String s)
    {
        ...
        video_lv = (ListView)view.findViewById(0x7f060293);
        adapter = new VideoDownloadedAdapter(getActivity(), listdd);
        video_lv.setAdapter(adapter);
    }
    ...
    {
        view = layoutinflater.inflate(0x7f0300a3, null, false);
