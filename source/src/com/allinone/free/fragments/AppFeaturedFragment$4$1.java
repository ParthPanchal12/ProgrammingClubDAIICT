...
class this._cls1
    implements com.allinone.free.utils._cls1
{
    ...
    {
        if (AppFeaturedFragment.access$6(_fld0) != null)
        {
            AppFeaturedFragment.access$7(_fld0, bitmap.getWidth());
            AppFeaturedFragment.access$8(_fld0, bitmap.getHeight());
            s = new android.widget.s(-1, getHeight(AppFeaturedFragment.access$9(_fld0), AppFeaturedFragment.access$10(_fld0)));
            AppFeaturedFragment.access$6(_fld0).setLayoutParams(s);
            AppFeaturedFragment.access$6(_fld0).setImageBitmap(bitmap);
        }
    }
...
/* anonymous class */
        ...
        implements IMNativeListener
    {
        ...
        // Unreferenced inner class com/allinone/free/fragments/AppFeaturedFragment$4$2

/* anonymous class */
        class AppFeaturedFragment._cls4._cls2
