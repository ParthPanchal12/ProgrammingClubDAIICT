    ...
    implements android.content..OnClickListener
{
    ...
    allback(allback allback, android.webkit.issions.Callback callback, String s)
    {
        c = allback;
        a = callback;
        b = s;
    ...
    class IMWebView._cls11 extends WebChromeClient
    {
        ...
        public void onGeolocationPermissionsShowPrompt(String s, android.webkit.GeolocationPermissions.Callback callback)
        {
            try
            {
                ...
                builder.setMessage("Allow location access").setCancelable(true).setPositiveButton("Accept", new IMWebView._cls11._cls2(this, callback, s)).setNegativeButton("Decline", new IMWebView._cls11._cls10(callback, s));
                builder.create().show();
