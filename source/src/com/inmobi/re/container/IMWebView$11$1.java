    ...
    class IMWebView._cls11 extends WebChromeClient
    {
        ...
        public void onGeolocationPermissionsShowPrompt(String s, android.webkit.GeolocationPermissions.Callback callback)
        {
            try
            {
                ...
                builder.setMessage("Allow location access").setCancelable(true).setPositiveButton("Accept", new IMWebView._cls11._cls2(callback, s)).setNegativeButton("Decline", new IMWebView._cls11._cls10(callback, s));
                builder.create().show();
...
_L4:
            (new android.app.AlertDialog.Builder(webview)).setTitle(s).setMessage(s1).setPositiveButton(0x104000a, new IMWebView._cls11._cls1(this, jsresult)).setCancelable(false).create().show();
...
_L1:
        ...
        // Unreferenced inner class com/inmobi/re/container/IMWebView$11$10

/* anonymous class */
        class IMWebView._cls11._cls10
