...
_L6:
    ...
    private static String a(String s1)
    {
        ...
        stringbuffer.append((new StringBuilder()).append("%").append(InternalSDKUtil.byteToHex(s1[i1])).toString());
        break MISSING_BLOCK_LABEL_94;
        stringbuffer.append((char)s1[i1]);
        break MISSING_BLOCK_LABEL_94;
    ...
    private void a(int i1)
    {
        if (n != null)
        {
            n.injectJavaScript((new StringBuilder()).append("window.mraidview.fireMediaErrorEvent('").append(a.id).append("',").append(i1).append(");").toString());
        }
    }
    ...
    private void a(int i1, int j1)
    {
        if (n != null)
        {
            n.injectJavaScript((new StringBuilder()).append("window.mraidview.fireMediaTimeUpdateEvent('").append(a.id).append("',").append(i1).append(",").append(j1).append(");").toString());
        }
    }
    ...
    private void a(boolean flag, int i1)
    {
        if (n != null)
        {
            n.injectJavaScript((new StringBuilder()).append("window.mraidview.fireMediaCloseEvent('").append(a.id).append("',").append(flag).append(",").append(i1).append(");").toString());
    ...
    private void b(String s1)
    {
        if (n != null)
        {
            n.injectJavaScript((new StringBuilder()).append("window.mraidview.fireMediaTrackingEvent('").append(s1).append("','").append(a.id).append("');").toString());
        }
    }
    ...
    private void d()
    {
        ...
        {
            Log.internal("[InMobi]-[RE]-4.5.5", "IMAVPlayer: unable to remove view");
            return;
        }
        if (viewgroup == null)
        {
        ...
        viewgroup = (ViewGroup)u.getParent();
        if (viewgroup == null)
        {
    ...
    private void g()
    {
        if (n != null)
        {
            n.injectJavaScript((new StringBuilder()).append("window.mraidview.fireMediaVolumeChangeEvent('").append(a.id).append("',").append(getVolume()).append(",").append(isMediaMuted()).append(");").toString());
        }
    }
    ...
    public void hide()
    {
        ...
        {
            Log.internal("[InMobi]-[RE]-4.5.5", "IMAVPlayer: unable to hide video");
        }
    }
    ...
    public void mute()
    {
        if (s != null && !t)
        {
            ...
            {
                Log.internal("[InMobi]-[RE]-4.5.5", "IMAVPlayer: unable to set volume (mute)");
            }
            g();
        }
    }
    ...
    {
        Log.debug("[InMobi]-[RE]-4.5.5", "AVPlayer-> onCompletion");
        ...
        {
            Log.internal("[InMobi]-[RE]-4.5.5", "IMAvplayer onCompletion exception ", mediaplayer);
        }
        return;
        if (a.exitOnComplete())
        {
    ...
    {
        Log.debug("[InMobi]-[RE]-4.5.5", (new StringBuilder()).append("AVPlayer-> Player error : ").append(i1).toString());
        f();
        releasePlayer(false);
        if (b != null)
        {
    ...
    {
        Log.debug("[InMobi]-[RE]-4.5.5", (new StringBuilder()).append("AVPlayer-> onIMVisibilityChanged: ").append(flag).toString());
        if (flag && !pseudoPause)
        {
    ...
    public void onPrepared(MediaPlayer mediaplayer)
    {
        ...
        if (t)
        {
            ...
            {
                Log.internal("[InMobi]-[RE]-4.5.5", "IMAVPlayer: unable to set volume");
            }
        }
        Log.debug("[InMobi]-[RE]-4.5.5", "AVPlayer-> onPrepared");
        f();
        if (b != null)
        {
            b.onPrepared(this);
    ...
    protected void onWindowVisibilityChanged(int i1)
    {
        ...
        {
            Log.internal("[InMobi]-[RE]-4.5.5", "IMAVPlayer: onWindowVisibilityChanged: Something went wrong");
            return;
        }
        if (i1 == 0)
        {
...
_L2:
        ...
        i();
        Log.debug("[InMobi]-[RE]-4.5.5", "AVPlayer-> pause");
        b(g);
...
_L4:
    ...
    public void releasePlayer(boolean flag)
    {
        if (n != null)
        {
            n.setOnTouchListener(new android.view.View.OnTouchListener() {
    ...
    public void setPlayData(com.inmobi.re.controller.JSController.PlayerProperties playerproperties, String s1)
    {
        ...
        if (o == null)
        {
            ...
            if (android.os.Build.VERSION.SDK_INT >= 8)
            {
                ...
                // Misplaced declaration of an exception variable
                catch (com.inmobi.re.controller.JSController.PlayerProperties playerproperties)
                {
                    Log.internal("[InMobi]-[RE]-4.5.5", "IMAVPlayer: unable to get video bitmap");
                }
                return;
            }
        }
...
_L2:
        ...
        m = false;
        h();
        Log.debug("[InMobi]-[RE]-4.5.5", "AVPlayer-> start playing");
        if (l)
        {
            b(f);
        }
