...
//            ActivityRecognitionSampler, ActivityRecognitionManager

static final class tivitySample extends Handler
{
...
_L2:
        ...
        ActivityRecognitionSampler.d.add(new tivitySample(i, System.currentTimeMillis()));
        break; /* Loop/switch isn't completed */
