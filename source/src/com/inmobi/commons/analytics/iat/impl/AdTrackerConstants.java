...
public class AdTrackerConstants
{
    public static final class StatusCode extends Enum
    {
        ...
        public static final StatusCode RELOAD_WEBVIEW_ERROR;
        private static final StatusCode a[];

        public static StatusCode valueOf(String s)
        {
            return (StatusCode)Enum.valueOf(com/inmobi/commons/analytics/iat/impl/AdTrackerConstants$StatusCode, s);
        }
        ...
        static 
        {
            ...
            RELOAD_WEBVIEW_ERROR = new StatusCode("RELOAD_WEBVIEW_ERROR", 6);
            a = (new StatusCode[] {
