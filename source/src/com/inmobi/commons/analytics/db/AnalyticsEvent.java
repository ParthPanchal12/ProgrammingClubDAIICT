...
{
    public static final class TRANSACTION_ITEM_TYPE extends Enum
    {
    ...
    public static final class TRANSACTION_STATUS_GOOGLE_API_VALUES extends Enum
    {

        public static final TRANSACTION_STATUS_GOOGLE_API_VALUES FAILED;
        public static final TRANSACTION_STATUS_GOOGLE_API_VALUES PURCHASED;
        public static final TRANSACTION_STATUS_GOOGLE_API_VALUES REFUNDED;
        private static final TRANSACTION_STATUS_GOOGLE_API_VALUES b[];
        private final int a;

        public static TRANSACTION_STATUS_GOOGLE_API_VALUES valueOf(String s1)
        {
            return (TRANSACTION_STATUS_GOOGLE_API_VALUES)Enum.valueOf(com/inmobi/commons/analytics/db/AnalyticsEvent$TRANSACTION_STATUS_GOOGLE_API_VALUES, s1);
        }

        public static TRANSACTION_STATUS_GOOGLE_API_VALUES[] values()
        {
            return (TRANSACTION_STATUS_GOOGLE_API_VALUES[])b.clone();
        }
        ...
        static 
        {
            PURCHASED = new TRANSACTION_STATUS_GOOGLE_API_VALUES("PURCHASED", 0, 0);
            FAILED = new TRANSACTION_STATUS_GOOGLE_API_VALUES("FAILED", 1, 1);
            REFUNDED = new TRANSACTION_STATUS_GOOGLE_API_VALUES("REFUNDED", 2, 2);
            b = (new TRANSACTION_STATUS_GOOGLE_API_VALUES[] {
                PURCHASED, FAILED, REFUNDED
            });
        }

        private TRANSACTION_STATUS_GOOGLE_API_VALUES(String s1, int i1, int j1)
        {
            super(s1, i1);
            a = j1;
        }
    ...
    public static final class TRANSACTION_STATUS_SERVER_CODE extends Enum
    {
        ...
        static 
        {
            ...
            b = (new TRANSACTION_STATUS_SERVER_CODE[] {
    ...
    public void setUserAttribute(String s1, String s2)
    {
        if (s1 != null && s2 != null && !"".equals(s1.trim()) && !"".equals(s2.trim()))
        {
            x = s1;
            y = s2;
        }
