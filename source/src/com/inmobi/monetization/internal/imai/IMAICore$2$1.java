    ...
    implements com.inmobi.commons.analytics.net.on.HttpRequestCallback
{
    ...
    // Unreferenced inner class com/inmobi/monetization/internal/imai/IMAICore$2

/* anonymous class */
    static final class IMAICore._cls2
        implements Runnable
    {
        ...
        public void run()
        {
            try
            {
                ...
                requestresponsemanager.processClick(InternalSDKUtil.getContext(), new IMAICore._cls2._cls1(this));
                return;
            }
