...
public final class VersionCode extends Enum
{
    ...
    {
        return (VersionCode)Enum.valueOf(com/yeahmobi/android/common/util/VersionCode, s);
    }
    ...
    static 
    {
        ...
        $VALUES = (new VersionCode[] {
            ...
            HONEYCOMB, HONEYCOMB_MR1, HONEYCOMB_MR2, ICE_CREAM_SANDWICH, ICE_CREAM_SANDWICH_MR1, JELLY_BEAN, JELLY_BEAN_MR1, JELLY_BEAN_MR2, CUR_DEVELOPMENT
        });
    }
}
