package com.example.spock.programmingclubdaiict.service;
...
import com.example.spock.programmingclubdaiict.SecondActivity;
...
public class NotifyService extends Service {
    ...
    private void showNotification(String details) {
        ...
        Notification notification = new Notification(icon, details, time);
